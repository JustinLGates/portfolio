...
const Header = () => {
  return (
    <div className="row index-1 text-center d-flex justify-content-center ">
      <div className="col-12 bg-light p-5 m-h-30 spacer-20">
        <h1 className="text-shadow-3 text-dark p-2">
          Justin Gates Software Developer
        </h1>
      </div>

      <div className="col-12 bg-light text-dark col-lg-6 p-1 py-2  bg-light px-2 px-lg-5 d-flex">
        <div className="text-left p-2 p-sm-3  ">
          <h2 className="d-inline p-2 text-shadow-3 px-3  text-dark">
          ...
          <p className=" p-2">
            ...
            projects. I enrolled in a bootcamp to solidify my knowledge building
            full stack web applications. I can not imagine doing anything other
      ...
      <div className="col-12 bg-light col-lg-6 p-1 py-2  bg-light justify-content-center">
        <div className="row">
